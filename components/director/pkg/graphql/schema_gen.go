...
type DirectiveRoot struct {
	...
	LimitAccess func(ctx context.Context, obj interface{}, next graphql.Resolver, ownerProvider string, idField string) (res interface{}, err error)
...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		GrantSystemAccess                             func(childComplexity int, in SystemAuthAccessInput) int
		...
		RevokeSystemAccess                            func(childComplexity int, in SystemAuthAccessInput) int
	...
	SystemAuthAccess struct {
		For func(childComplexity int) int
		To  func(childComplexity int) int
	}

	SystemAuthAccessFor struct {
...
type MutationResolver interface {
	...
	GrantSystemAccess(ctx context.Context, in SystemAuthAccessInput) (*SystemAuthAccess, error)
	RevokeSystemAccess(ctx context.Context, in SystemAuthAccessInput) (*SystemAuthAccess, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.grantSystemAccess":
		if e.complexity.Mutation.GrantSystemAccess == nil {
			break
		}

		args, err := ec.field_Mutation_grantSystemAccess_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.GrantSystemAccess(childComplexity, args["in"].(SystemAuthAccessInput)), true
	...
	case "Mutation.revokeSystemAccess":
		if e.complexity.Mutation.RevokeSystemAccess == nil {
			break
		}

		args, err := ec.field_Mutation_revokeSystemAccess_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.RevokeSystemAccess(childComplexity, args["in"].(SystemAuthAccessInput)), true
	...
	case "SystemAuthAccess.for":
		if e.complexity.SystemAuthAccess.For == nil {
			break
		}

		return e.complexity.SystemAuthAccess.For(childComplexity), true

	case "SystemAuthAccess.to":
		if e.complexity.SystemAuthAccess.To == nil {
			break
		}

		return e.complexity.SystemAuthAccess.To(childComplexity), true

	case "SystemAuthAccessFor.applicationID":
		if e.complexity.SystemAuthAccessFor.ApplicationID == nil {
			break
		}

		return e.complexity.SystemAuthAccessFor.ApplicationID(childComplexity), true

	case "SystemAuthAccessFor.applicationTemplateID":
		if e.complexity.SystemAuthAccessFor.ApplicationTemplateID == nil {
			break
		}

		return e.complexity.SystemAuthAccessFor.ApplicationTemplateID(childComplexity), true

	case "SystemAuthAccessFor.integrationSystemID":
		if e.complexity.SystemAuthAccessFor.IntegrationSystemID == nil {
			break
		}

		return e.complexity.SystemAuthAccessFor.IntegrationSystemID(childComplexity), true

	case "SystemAuthAccessFor.runtimeID":
		if e.complexity.SystemAuthAccessFor.RuntimeID == nil {
			break
		}

		return e.complexity.SystemAuthAccessFor.RuntimeID(childComplexity), true

	case "SystemAuthAccessTo.applicationID":
		if e.complexity.SystemAuthAccessTo.ApplicationID == nil {
			break
		}

		return e.complexity.SystemAuthAccessTo.ApplicationID(childComplexity), true

	case "SystemAuthAccessTo.integrationSystemID":
		if e.complexity.SystemAuthAccessTo.IntegrationSystemID == nil {
			break
		}

		return e.complexity.SystemAuthAccessTo.IntegrationSystemID(childComplexity), true

	case "SystemAuthAccessTo.runtimeID":
		if e.complexity.SystemAuthAccessTo.RuntimeID == nil {
			break
		}

		return e.complexity.SystemAuthAccessTo.RuntimeID(childComplexity), true
...
"""
LimitAccess directive limits the access to a query or a mutation only to allowed consumers.
"""
...
type Query {
	...
	**Examples**
	...
	"""
	applicationsForRuntime(runtimeID: ID!, first: Int = 100, after: PageCursor): ApplicationPage! @hasScopes(path: "graphql.query.applicationsForRuntime") @limitAccess(ownerProvider: "GetRuntimeID", idField: "runtimeID")
	"""
	Maximum ` + "`" + `first` + "`" + ` parameter value is 100
	...
	**Examples**
	...
	"""
	runtime(id: ID!): Runtime @hasScopes(path: "graphql.query.runtime") @limitAccess(ownerProvider: "GetRuntimeID", idField: "id")
	...
	**Examples**
	...
	"""
	integrationSystem(id: ID!): IntegrationSystem @hasScopes(path: "graphql.query.integrationSystem") @limitAccess(ownerProvider: "GetIntegrationSystemID", idField: "id")
...
type Mutation {
	...
	**Examples**
	...
	"""
	updateApplication(id: ID!, in: ApplicationUpdateInput! @validate): Application! @hasScopes(path: "graphql.mutation.updateApplication") @limitAccess(ownerProvider: "GetApplicationID", idField: "id")
	"""
	**Examples**
	- [unregister application](examples/unregister-application/unregister-application.graphql)
	"""
	unregisterApplication(id: ID!): Application! @hasScopes(path: "graphql.mutation.unregisterApplication") @limitAccess(ownerProvider: "GetApplicationID", idField: "id")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	updateApplicationTemplate(id: ID!, in: ApplicationTemplateInput! @validate): ApplicationTemplate! @hasScopes(path: "graphql.mutation.updateApplicationTemplate") @limitAccess(ownerProvider: "GetApplicationTemplateIDByAuthID", idField: "id")
	"""
	**Examples**
	- [delete application template](examples/delete-application-template/delete-application-template.graphql)
	"""
	deleteApplicationTemplate(id: ID!): ApplicationTemplate! @hasScopes(path: "graphql.mutation.deleteApplicationTemplate") @limitAccess(ownerProvider: "GetApplicationTemplateIDByAuthID", idField: "id")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	updateRuntime(id: ID!, in: RuntimeInput! @validate): Runtime! @hasScopes(path: "graphql.mutation.updateRuntime") @limitAccess(ownerProvider: "GetRuntimeID", idField: "id")
	"""
	**Examples**
	- [unregister runtime](examples/unregister-runtime/unregister-runtime.graphql)
	"""
	unregisterRuntime(id: ID!): Runtime! @hasScopes(path: "graphql.mutation.unregisterRuntime") @limitAccess(ownerProvider: "GetRuntimeID", idField: "id")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	updateIntegrationSystem(id: ID!, in: IntegrationSystemInput! @validate): IntegrationSystem! @hasScopes(path: "graphql.mutation.updateIntegrationSystem") @limitAccess(ownerProvider: "GetIntegrationSystemID", idField: "id")
	"""
	**Examples**
	- [unregister integration system](examples/unregister-integration-system/unregister-integration-system.graphql)
	"""
	unregisterIntegrationSystem(id: ID!): IntegrationSystem! @hasScopes(path: "graphql.mutation.unregisterIntegrationSystem") @limitAccess(ownerProvider: "GetIntegrationSystemID", idField: "id")
	"""
	**Examples**
	- [add application webhook](examples/add-webhook/add-application-webhook.graphql)
	"""
	addWebhook(applicationID: ID!, in: WebhookInput! @validate): Webhook! @hasScopes(path: "graphql.mutation.addWebhook") @limitAccess(ownerProvider: "GetApplicationID", idField: "applicationID")
	"""
	**Examples**
	- [update application webhook](examples/update-webhook/update-application-webhook.graphql)
	"""
	updateWebhook(webhookID: ID!, in: WebhookInput! @validate): Webhook! @hasScopes(path: "graphql.mutation.updateWebhook") @limitAccess(ownerProvider: "GetApplicationIDByWebhookID", idField: "webhookID")
	"""
	**Examples**
	- [delete application webhook](examples/delete-webhook/delete-application-webhook.graphql)
	"""
	deleteWebhook(webhookID: ID!): Webhook! @hasScopes(path: "graphql.mutation.deleteWebhook") @limitAccess(ownerProvider: "GetApplicationIDByWebhookID", idField: "webhookID")
	"""
	**Examples**
	- [add api definition to package](examples/add-api-definition-to-package/add-api-definition-to-package.graphql)
	"""
	addAPIDefinitionToPackage(packageID: ID!, in: APIDefinitionInput! @validate): APIDefinition! @hasScopes(path: "graphql.mutation.addAPIDefinitionToPackage") @limitAccess(ownerProvider: "GetApplicationIDByPackageID", idField: "packageID")
	"""
	**Examples**
	- [update api definition](examples/update-api-definition/update-api-definition.graphql)
	"""
	updateAPIDefinition(id: ID!, in: APIDefinitionInput! @validate): APIDefinition! @hasScopes(path: "graphql.mutation.updateAPIDefinition") @limitAccess(ownerProvider: "GetApplicationIDByAPIDefinitionID", idField: "id")
	"""
	**Examples**
	- [delete api definition](examples/delete-api-definition/delete-api-definition.graphql)
	"""
	deleteAPIDefinition(id: ID!): APIDefinition! @hasScopes(path: "graphql.mutation.deleteAPIDefinition") @limitAccess(ownerProvider: "GetApplicationIDByAPIDefinitionID", idField: "id")
	"""
	**Examples**
	- [refetch api spec](examples/refetch-api-spec/refetch-api-spec.graphql)
	"""
	refetchAPISpec(apiID: ID!): APISpec! @hasScopes(path: "graphql.mutation.refetchAPISpec") @limitAccess(ownerProvider: "GetApplicationIDByAPIDefinitionID", idField: "apiID")
	...
	deleteSystemAuthForRuntime(authID: ID!): SystemAuth! @hasScopes(path: "graphql.mutation.deleteSystemAuthForRuntime") @limitAccess(ownerProvider: "GetRuntimeIDByAuthID", idField: "authID")
	deleteSystemAuthForApplication(authID: ID!): SystemAuth! @hasScopes(path: "graphql.mutation.deleteSystemAuthForApplication") @limitAccess(ownerProvider: "GetApplicationIDByAuthID", idField: "authID")
	deleteSystemAuthForIntegrationSystem(authID: ID!): SystemAuth! @hasScopes(path: "graphql.mutation.deleteSystemAuthForIntegrationSystem") @limitAccess(ownerProvider: "GetIntegrationSystemIDByAuthID", idField: "authID")
	"""
	**Examples**
	- [add event definition to package](examples/add-event-definition-to-package/add-event-definition-to-package.graphql)
	"""
	addEventDefinitionToPackage(packageID: ID!, in: EventDefinitionInput! @validate): EventDefinition! @hasScopes(path: "graphql.mutation.addEventDefinitionToPackage") @limitAccess(ownerProvider: "GetApplicationIDByPackageID", idField: "packageID")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	deleteEventDefinition(id: ID!): EventDefinition! @hasScopes(path: "graphql.mutation.deleteEventDefinition") @limitAccess(ownerProvider: "GetApplicationIDByEventDefinitionID", idField: "id")
	refetchEventDefinitionSpec(eventID: ID!): EventSpec! @hasScopes(path: "graphql.mutation.refetchEventDefinitionSpec") @limitAccess(ownerProvider: "GetApplicationIDByEventDefinitionID", idField: "eventID")
	"""
	**Examples**
	- [add document to package](examples/add-document-to-package/add-document-to-package.graphql)
	"""
	addDocumentToPackage(packageID: ID!, in: DocumentInput! @validate): Document! @hasScopes(path: "graphql.mutation.addDocumentToPackage") @limitAccess(ownerProvider: "GetApplicationIDByPackageID", idField: "packageID")
	"""
	**Examples**
	- [delete document](examples/delete-document/delete-document.graphql)
	"""
	deleteDocument(id: ID!): Document! @hasScopes(path: "graphql.mutation.deleteDocument") @limitAccess(ownerProvider: "GetApplicationIDByDocumentID", idField: "id")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	setApplicationLabel(applicationID: ID!, key: String!, value: Any!): Label! @hasScopes(path: "graphql.mutation.setApplicationLabel") @limitAccess(ownerProvider: "GetApplicationID", idField: "applicationID")
	"""
	...
	**Examples**
	...
	"""
	deleteApplicationLabel(applicationID: ID!, key: String!): Label! @hasScopes(path: "graphql.mutation.deleteApplicationLabel") @limitAccess(ownerProvider: "GetApplicationID", idField: "applicationID")
	"""
	If a label with given key already exist, it will be replaced with provided value.
	"""
	setRuntimeLabel(runtimeID: ID!, key: String!, value: Any!): Label! @hasScopes(path: "graphql.mutation.setRuntimeLabel") @limitAccess(ownerProvider: "GetRuntimeID", idField: "runtimeID")
	"""
	If Runtime does not exist or the label key is not found, it returns an error.
	"""
	deleteRuntimeLabel(runtimeID: ID!, key: String!): Label! @hasScopes(path: "graphql.mutation.deleteRuntimeLabel") @limitAccess(ownerProvider: "GetRuntimeID", idField: "runtimeID")
	...
	**Examples**
	...
	"""
	setPackageInstanceAuth(authID: ID!, in: PackageInstanceAuthSetInput! @validate): PackageInstanceAuth! @hasScopes(path: "graphql.mutation.setPackageInstanceAuth") @limitAccess(ownerProvider: "GetApplicationIDByPackageInstanceAuthID", idField: "authID")
	"""
	**Examples**
	- [delete package instance auth](examples/delete-package-instance-auth/delete-package-instance-auth.graphql)
	"""
	deletePackageInstanceAuth(authID: ID!): PackageInstanceAuth! @hasScopes(path: "graphql.mutation.deletePackageInstanceAuth") @limitAccess(ownerProvider: "GetApplicationIDByPackageInstanceAuthID", idField: "authID")
	"""
	...
	**Examples**
	...
	"""
	addPackage(applicationID: ID!, in: PackageCreateInput! @validate): Package! @hasScopes(path: "graphql.mutation.addPackage") @limitAccess(ownerProvider: "GetApplicationID", idField: "applicationID")
	"""
	**Examples**
	- [update package](examples/update-package/update-package.graphql)
	"""
	updatePackage(id: ID!, in: PackageUpdateInput! @validate): Package! @hasScopes(path: "graphql.mutation.updatePackage") @limitAccess(ownerProvider: "GetApplicationIDByPackageID", idField: "id")
	"""
	**Examples**
	- [delete package](examples/delete-package/delete-package.graphql)
	"""
	deletePackage(id: ID!): Package! @hasScopes(path: "graphql.mutation.deletePackage") @limitAccess(ownerProvider: "GetApplicationIDByPackageID", idField: "id")
	"""
	**Examples**
...
func (ec *executionContext) dir_limitAccess_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["ownerProvider"]; ok {
		arg0, err = ec.unmarshalNString2string(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
	args["ownerProvider"] = arg0
	var arg1 string
...
func (ec *executionContext) field_Mutation_grantSystemAccess_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 SystemAuthAccessInput
	if tmp, ok := rawArgs["in"]; ok {
		directive0 := func(ctx context.Context) (interface{}, error) {
			return ec.unmarshalNSystemAuthAccessInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessInput(ctx, tmp)
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			if ec.directives.Validate == nil {
				return nil, errors.New("directive validate is not implemented")
		...
		if data, ok := tmp.(SystemAuthAccessInput); ok {
			arg0 = data
		} else {
			return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/kyma-incubator/compass/components/director/pkg/graphql.SystemAuthAccessInput`, tmp)
		}
	}
	args["in"] = arg0
	return args, nil
...
func (ec *executionContext) field_Mutation_revokeSystemAccess_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 SystemAuthAccessInput
	if tmp, ok := rawArgs["in"]; ok {
...
func (ec *executionContext) _Mutation_updateApplication(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationID")
			if err != nil {
				return nil, err
			}
			...
			if ec.directives.LimitAccess == nil {
				return nil, errors.New("directive limitAccess is not implemented")
			}
			return ec.directives.LimitAccess(ctx, nil, directive1, ownerProvider, idField)
		}
...
func (ec *executionContext) _Mutation_updateApplicationTemplate(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationTemplateIDByAuthID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "id")
...
func (ec *executionContext) _Mutation_updateRuntime(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetRuntimeID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "id")
...
func (ec *executionContext) _Mutation_updateIntegrationSystem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetIntegrationSystemID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "id")
...
func (ec *executionContext) _Mutation_updateWebhook(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByWebhookID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "webhookID")
			if err != nil {
				return nil, err
			}
			if ec.directives.LimitAccess == nil {
...
func (ec *executionContext) _Mutation_addAPIDefinitionToPackage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByPackageID")
			if err != nil {
				return nil, err
			}
...
func (ec *executionContext) _Mutation_updateAPIDefinition(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByAPIDefinitionID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "id")
...
func (ec *executionContext) _Mutation_refetchAPISpec(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			...
			idField, err := ec.unmarshalNString2string(ctx, "apiID")
			if err != nil {
				return nil, err
			}
			if ec.directives.LimitAccess == nil {
...
func (ec *executionContext) _Mutation_deleteSystemAuthForRuntime(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetRuntimeIDByAuthID")
			if err != nil {
				return nil, err
			}
...
func (ec *executionContext) _Mutation_deleteSystemAuthForApplication(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByAuthID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "authID")
...
func (ec *executionContext) _Mutation_deleteSystemAuthForIntegrationSystem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetIntegrationSystemIDByAuthID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "authID")
...
func (ec *executionContext) _Mutation_updateEventDefinition(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByEventDefinitionID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "id")
...
func (ec *executionContext) _Mutation_refetchEventDefinitionSpec(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			...
			idField, err := ec.unmarshalNString2string(ctx, "eventID")
			if err != nil {
				return nil, err
			}
			if ec.directives.LimitAccess == nil {
...
func (ec *executionContext) _Mutation_deleteDocument(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByDocumentID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "id")
...
func (ec *executionContext) _Mutation_setPackageInstanceAuth(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive2 := func(ctx context.Context) (interface{}, error) {
			ownerProvider, err := ec.unmarshalNString2string(ctx, "GetApplicationIDByPackageInstanceAuthID")
			if err != nil {
				return nil, err
			}
			idField, err := ec.unmarshalNString2string(ctx, "authID")
...
func (ec *executionContext) _Mutation_grantSystemAccess(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Mutation_grantSystemAccess_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().GrantSystemAccess(rctx, args["in"].(SystemAuthAccessInput))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			path, err := ec.unmarshalNString2string(ctx, "graphql.mutation.grantSystemAccess")
			if err != nil {
				return nil, err
			}
			if ec.directives.HasScopes == nil {
		...
		if data, ok := tmp.(*SystemAuthAccess); ok {
			return data, nil
		}
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/kyma-incubator/compass/components/director/pkg/graphql.SystemAuthAccess`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*SystemAuthAccess)
	fc.Result = res
	return ec.marshalOSystemAuthAccess2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccess(ctx, field.Selections, res)
}

func (ec *executionContext) _Mutation_revokeSystemAccess(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Mutation_revokeSystemAccess_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().RevokeSystemAccess(rctx, args["in"].(SystemAuthAccessInput))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			path, err := ec.unmarshalNString2string(ctx, "graphql.mutation.revokeSystemAccess")
			if err != nil {
				return nil, err
			}
			if ec.directives.HasScopes == nil {
...
func (ec *executionContext) _Package_instanceAuths(ctx context.Context, field graphql.CollectedField, obj *Package) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*PackageInstanceAuth)
	fc.Result = res
	return ec.marshalNPackageInstanceAuth2ᚕᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐPackageInstanceAuthᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _PackagePage_data(ctx context.Context, field graphql.CollectedField, obj *PackagePage) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Package)
	fc.Result = res
	return ec.marshalNPackage2ᚕᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐPackageᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _SystemAuthAccess_to(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccess) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	res := resTmp.(*SystemAuthAccessTo)
	fc.Result = res
	return ec.marshalNSystemAuthAccessTo2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessTo(ctx, field.Selections, res)
}

func (ec *executionContext) _SystemAuthAccess_for(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccess) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	res := resTmp.(*SystemAuthAccessFor)
	fc.Result = res
	return ec.marshalNSystemAuthAccessFor2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessFor(ctx, field.Selections, res)
}

func (ec *executionContext) _SystemAuthAccessFor_applicationID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessFor) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _SystemAuthAccessFor_applicationTemplateID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessFor) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _SystemAuthAccessFor_runtimeID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessFor) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _SystemAuthAccessFor_integrationSystemID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessFor) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _SystemAuthAccessTo_applicationID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessTo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _SystemAuthAccessTo_runtimeID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessTo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _SystemAuthAccessTo_integrationSystemID(ctx context.Context, field graphql.CollectedField, obj *SystemAuthAccessTo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputApplicationRegisterInput(ctx context.Context, obj interface{}) (ApplicationRegisterInput, error) {
	...
	for k, v := range asMap {
		...
		case "packages":
			var err error
			it.Packages, err = ec.unmarshalOPackageCreateInput2ᚕᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐPackageCreateInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
...
func (ec *executionContext) unmarshalInputSystemAuthAccessForInput(ctx context.Context, obj interface{}) (SystemAuthAccessForInput, error) {
	var it SystemAuthAccessForInput
	var asMap = obj.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "applicationTemplateID":
			var err error
			it.ApplicationTemplateID, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "runtimeID":
		...
		case "integrationSystemID":
			var err error
			it.IntegrationSystemID, err = ec.unmarshalOString2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputSystemAuthAccessInput(ctx context.Context, obj interface{}) (SystemAuthAccessInput, error) {
	var it SystemAuthAccessInput
	var asMap = obj.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "to":
			var err error
			it.To, err = ec.unmarshalNSystemAuthAccessToInput2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessToInput(ctx, v)
			if err != nil {
				return it, err
			}
		case "for":
			var err error
			it.For, err = ec.unmarshalNSystemAuthAccessForInput2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessForInput(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputSystemAuthAccessToInput(ctx context.Context, obj interface{}) (SystemAuthAccessToInput, error) {
	var it SystemAuthAccessToInput
	var asMap = obj.(map[string]interface{})
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "grantSystemAccess":
			out.Values[i] = ec._Mutation_grantSystemAccess(ctx, field)
		case "revokeSystemAccess":
			out.Values[i] = ec._Mutation_revokeSystemAccess(ctx, field)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _PackageInstanceAuth(ctx context.Context, sel ast.SelectionSet, obj *PackageInstanceAuth) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, packageInstanceAuthImplementors)
...
func (ec *executionContext) _PackageInstanceAuthStatus(ctx context.Context, sel ast.SelectionSet, obj *PackageInstanceAuthStatus) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, packageInstanceAuthStatusImplementors)
...
func (ec *executionContext) _PackagePage(ctx context.Context, sel ast.SelectionSet, obj *PackagePage) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, packagePageImplementors)
...
var systemAuthAccessImplementors = []string{"SystemAuthAccess"}

func (ec *executionContext) _SystemAuthAccess(ctx context.Context, sel ast.SelectionSet, obj *SystemAuthAccess) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, systemAuthAccessImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("SystemAuthAccess")
		case "to":
			out.Values[i] = ec._SystemAuthAccess_to(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "for":
			out.Values[i] = ec._SystemAuthAccess_for(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
var systemAuthAccessForImplementors = []string{"SystemAuthAccessFor"}

func (ec *executionContext) _SystemAuthAccessFor(ctx context.Context, sel ast.SelectionSet, obj *SystemAuthAccessFor) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, systemAuthAccessForImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("SystemAuthAccessFor")
		case "applicationID":
			out.Values[i] = ec._SystemAuthAccessFor_applicationID(ctx, field, obj)
		case "applicationTemplateID":
			out.Values[i] = ec._SystemAuthAccessFor_applicationTemplateID(ctx, field, obj)
		case "runtimeID":
			out.Values[i] = ec._SystemAuthAccessFor_runtimeID(ctx, field, obj)
		case "integrationSystemID":
			out.Values[i] = ec._SystemAuthAccessFor_integrationSystemID(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
var systemAuthAccessToImplementors = []string{"SystemAuthAccessTo"}

func (ec *executionContext) _SystemAuthAccessTo(ctx context.Context, sel ast.SelectionSet, obj *SystemAuthAccessTo) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, systemAuthAccessToImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("SystemAuthAccessTo")
		case "applicationID":
			out.Values[i] = ec._SystemAuthAccessTo_applicationID(ctx, field, obj)
		case "runtimeID":
			out.Values[i] = ec._SystemAuthAccessTo_runtimeID(ctx, field, obj)
		case "integrationSystemID":
			out.Values[i] = ec._SystemAuthAccessTo_integrationSystemID(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) marshalNPackage2ᚕᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐPackageᚄ(ctx context.Context, sel ast.SelectionSet, v []*Package) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
...
func (ec *executionContext) marshalNPackageInstanceAuth2ᚕᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐPackageInstanceAuthᚄ(ctx context.Context, sel ast.SelectionSet, v []*PackageInstanceAuth) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
...
func (ec *executionContext) marshalNSystemAuthAccessFor2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessFor(ctx context.Context, sel ast.SelectionSet, v SystemAuthAccessFor) graphql.Marshaler {
	return ec._SystemAuthAccessFor(ctx, sel, &v)
}

func (ec *executionContext) marshalNSystemAuthAccessFor2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessFor(ctx context.Context, sel ast.SelectionSet, v *SystemAuthAccessFor) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNSystemAuthAccessForInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessForInput(ctx context.Context, v interface{}) (SystemAuthAccessForInput, error) {
	return ec.unmarshalInputSystemAuthAccessForInput(ctx, v)
}

func (ec *executionContext) unmarshalNSystemAuthAccessForInput2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessForInput(ctx context.Context, v interface{}) (*SystemAuthAccessForInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalNSystemAuthAccessForInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessForInput(ctx, v)
	return &res, err
}

func (ec *executionContext) unmarshalNSystemAuthAccessInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessInput(ctx context.Context, v interface{}) (SystemAuthAccessInput, error) {
	return ec.unmarshalInputSystemAuthAccessInput(ctx, v)
}

func (ec *executionContext) marshalNSystemAuthAccessTo2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessTo(ctx context.Context, sel ast.SelectionSet, v SystemAuthAccessTo) graphql.Marshaler {
	return ec._SystemAuthAccessTo(ctx, sel, &v)
}

func (ec *executionContext) marshalNSystemAuthAccessTo2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessTo(ctx context.Context, sel ast.SelectionSet, v *SystemAuthAccessTo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNSystemAuthAccessToInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessToInput(ctx context.Context, v interface{}) (SystemAuthAccessToInput, error) {
	return ec.unmarshalInputSystemAuthAccessToInput(ctx, v)
}

func (ec *executionContext) unmarshalNSystemAuthAccessToInput2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessToInput(ctx context.Context, v interface{}) (*SystemAuthAccessToInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalNSystemAuthAccessToInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccessToInput(ctx, v)
	return &res, err
}
...
func (ec *executionContext) unmarshalOPackageCreateInput2ᚕᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐPackageCreateInputᚄ(ctx context.Context, v interface{}) ([]*PackageCreateInput, error) {
	var vSlice []interface{}
	if v != nil {
		if tmp1, ok := v.([]interface{}); ok {
			vSlice = tmp1
...
func (ec *executionContext) marshalOSystemAuthAccess2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccess(ctx context.Context, sel ast.SelectionSet, v SystemAuthAccess) graphql.Marshaler {
	return ec._SystemAuthAccess(ctx, sel, &v)
}

func (ec *executionContext) marshalOSystemAuthAccess2ᚖgithubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐSystemAuthAccess(ctx context.Context, sel ast.SelectionSet, v *SystemAuthAccess) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._SystemAuthAccess(ctx, sel, v)
